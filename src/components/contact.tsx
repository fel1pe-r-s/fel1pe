...
export function Contact() {
  return (
    <section
      id="contact"
      className="flex flex-col gap-6 md:gap-12 justify-center items-center w-80 md:w-[500px]"
    >
      ...
      <div className="flex flex-col gap-2 justify-center items-center w-full ">
        <Link
          ...
          className="w-full"
        >
          <Button className="w-full flex gap-3 items-center justify-between p-6 hover:text-popover">
